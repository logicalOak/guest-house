...
const Advantages = () => (
	<section className='pl-2 pr-2 text-[#52503b] bg-[#FAF8F0] pt-[50px] pb-[50px] lg:pt-[100px] lg:pb-[100px]'>
		<div className='w-full m-auto text-center max-w-[1168px]'>
			...
			<ul className='advantages__list grid gap-3 lg:grid-cols-3 lg:gap-5'>
				<li className='flex flex-col gap-2 items-center'>
					...
					<h3>Beds</h3>
					<p>
						The cabin is equipped with 12 beds, 4 of which are in bunk. The rent includes linens for
						all beds.
					</p>
				</li>
				<li className='flex flex-col gap-2 items-center'>
					...
					<h3>Bedrooms</h3>
					<p>
						Spread out over two floors, the cabin offers 4 bedrooms. Ranging from 2 to 4 beds per
						room.
					</p>
				</li>
				<li className='flex flex-col gap-2 items-center'>
